...
指令 (Directives) 是带有 `v-` 前缀的特殊属性。指令属性的预期值是：**单个 JavaScript 表达式**。指令的职责是，当表达式的值改变时，将其产生的连带影响，响应式地作用于 DOM。 
...
![1554866324826](assets/1554866324826.png)

![1554866348590](assets/1554866348590.png)

![1554866387767](assets/1554866387767.png)

---

> class属性的特殊使用方法

上面使用了两个按钮，我们来使用一个按钮，让代码更加优雅：
...
![1554867366478](assets/1554867366478.png)
...
![1554870464958](assets/1554870464958.png)

![1554870488553](assets/1554870488553.png)
...
![1554870345670](assets/1554870345670.png)
...
![1554875519996](assets/1554875519996.png)
